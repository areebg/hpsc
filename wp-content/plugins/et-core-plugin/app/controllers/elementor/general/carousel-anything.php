...
//        );
        ...
        $repeater->add_control(
            ...
            [
                ...
                'default' => count($global_widgets) ? array_key_first($global_widgets) : 'select',
                'condition' => [
        ...
        $repeater->add_control(
            ...
            [
                ...
                'default' => count($saved_templates) ? array_key_first($saved_templates) : 'select',
                'condition' => [
                    'content_type' => 'saved_template'
                ],
            ]
        ...
        $repeater->add_control(
            ...
            [
                ...
                'default' => count($static_blocks) ? array_key_first($static_blocks) : 'select',
                'condition' => [
                    'content_type' => 'static_block'
                ],
            ]
        ...
        $repeater->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::SELECT,
                'options' => $slides,
                'default' => count($slides) ? array_key_first($slides) : 'select',
                'condition' => [
...
//                            }
            ...
            $slides_rendered[$slide['_id']] = ob_get_clean();
        }
        if ( count($slides_css) ) {
