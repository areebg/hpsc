...
//				'mobile_default' => 2,
    ...
    public static function print_static_block($setting = '', $echo = true) {
        if (!empty($setting) && defined('ETHEME_THEME_VERSION') ) {
            ...
            echo esc_html__('Selected static block was removed or unpublished', 'xstore-core');
        }
    }
    ...
    public static function get_slider_arrows_position_locked_injection($widget, $of = 'arrows_position', $control_type = 'control') {
        if ( \Elementor\Plugin::$instance->experiments->is_feature_active( 'e_swiper_latest' ) ) {
            ...
            $widget->add_control(
                ...
                [
                    'type' => \Elementor\Controls_Manager::RAW_HTML,
                    'raw' => sprintf(esc_html__('This position will work only when %s feature be set to inactive.', 'xstore-core'), '<a href="' . admin_url('admin.php?page=elementor#tab-experiments') . '">' . esc_html__('Upgrade Swiper Library', 'xstore-core') . '</a>'),
