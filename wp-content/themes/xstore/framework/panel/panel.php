    ...
    public function et_add_menu_page(){
        ...
        if ( $is_activated && $is_et_core ) {
            ...
            add_submenu_page(
                ...
                esc_html__('AMP XStore', 'xstore'),
                'manage_options',
                (!class_exists('XStore_AMP') || !$is_activated ? 'et-panel-plugins' : 'et-panel-xstore-amp'),
                (!class_exists('XStore_AMP') || !$is_activated ? array($this, 'etheme_panel_page') : '')
            );
        ...
        if ( $is_activated && $is_et_core && $is_wc && in_array( 'sales_booster', $show_pages ) ) {
            add_menu_page(
